...
public class UserService {
    ...
    @Autowired
    private UserRepositoryData userRepositoryData;

    @Autowired
    private ObjectMapper objectMapper;

    public UserDto getUserDetails(String userEmailId) {
        UserDao userDao = userRepositoryData.findByEmailId(userEmailId).orElse(null);
    ...
    public boolean registerNewUser(UserDto userDto) {
        if(userRepositoryData.findByEmailId(userDto.getEmailId()).isEmpty()) {
    ...
    public boolean removeUserByEmailId(String userEmailId) {
        ...
        if(userDao == null) {
            ...
            userRepositoryData.delete(userDao);
            return true;
        }
    }

    public UserDto updateUserDetails(UserDto userDto) {
        UserDao userDao = userRepositoryData.findByEmailId(userDto.getEmailId()).orElse(null);
